{-# LANGUAGE RankNTypes, TemplateHaskell, ViewPatterns, RecordWildCards, OverloadedStrings, NoImplicitPrelude #-}
...
cutFromTo (from, to) o | from >= to = error "cutFromTo: from >= to"
...
atDepth 0 f o         = f o
atDepth n f o         = (\x -> o & orgSubtrees .~ x)
