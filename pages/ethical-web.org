...
* Behavior
[[https://blog.matsu.io/stop-breaking-links-with-javascript][Stop breaking links with javascript]] :: the web app should act exactly as one would expect a typical website to do. Back buttons should be reproduced to have consistent behavior at the least!
* Accessibility
** Resources
- REact ESLint Plugin
