...
#+hugo_slug: exwm
#+title: EXWM
[[https://github.com/ch11ng/exwm][EXWM]] is an[[file:../tools/emacs.org][ Emacs]] window manager.
...
[[https://github.com/walseb/exwm-firefox-evil][Firefox compatibility layer]] to allow for the use of
